...
def ion_ode(t, Q, i, presence, env, chemParams, climate, release, bgConc,
    ...
    rw_diff_n_2_air, fw_diff_n_2_air, sw_diff_n_2_air, soil1_diff_n_2_air,soil2_diff_n_2_air, soil3_diff_n_2_air, soil4_diff_n_2_air, \
    ...
    soilS4_windErosion_n_2_air, soilS4_windErosion_i_2_air = \
        rw_diff_n_to_air, fw_diff_n_to_air, sw_diff_n_to_air, soil1_diff_n_to_air, soil2_diff_n_to_air, soil3_diff_n_to_air, soil4_diff_n_to_air, \
    ...
    if presence['air'] == 0:
        ...
        air_diff_n_to_rw, air_diff_n_to_fw, air_diff_n_to_sw, air_diff_n_to_soil1, air_diff_n_to_soil2, air_diff_n_to_soil3, \
        ...
        soilS2_windErosion_n_2_air, soilS2_windErosion_i_2_air, soilS3_windErosion_n_2_air, soilS3_windErosion_i_2_air, \
        soilS4_windErosion_n_2_air, soilS4_windErosion_i_2_air = [0] * 35
    ...
    air_loss = - (air_deg_n + aer_deg_n + aer_deg_i + airOut_adv_n + aerOut_adv_n + aerOut_adv_i +
                  ...
                  air_diff_n_to_rw + air_diff_n_to_fw +air_diff_n_to_sw + air_diff_n_to_soil1 + air_diff_n_to_soil2 +
                  air_diff_n_to_soil3 + air_diff_n_to_soil4)
    air_transfer = rw_diff_n_2_air + fw_diff_n_2_air +sw_diff_n_2_air + soil1_diff_n_2_air + soil2_diff_n_2_air + \
    ...
    # riverwater - rw Q[1]
    rw_enter = release['rw'][i] + release['rSS'][i] + rwIn_adv_n + rwIn_adv_i

    air_rain_diss_n_2_rw, aer_dep_wet_n_2_rSS, aer_dep_wet_i_2_rSS, \
    aer_dep_dry_n_2_rSS, aer_dep_dry_i_2_rSS, air_diff_n_2_rw, rSedW_diff_n_2_rw, \
    rSedW_diff_i_2_rw, rSedS_resusp_n_2_rw, rSedS_resusp_i_2_rw, soilW1_runoff_n_2_rw, soilW1_runoff_i_2_rw, \
    soilS1_erosion_n_2_rw, soilS1_erosion_i_2_rw, deepS1_leach_n_2_rw, deepS1_leach_i_2_rw, soilW2_runoff_n_2_rw, \
    soilW2_runoff_i_2_rw, soilS2_erosion_n_2_rw, soilS2_erosion_i_2_rw, deepS2_leach_n_2_rw, deepS2_leach_i_2_rw, \
    soilW3_runoff_n_2_rw, soilW3_runoff_i_2_rw, soilS3_erosion_n_2_rw, soilS3_erosion_i_2_rw, deepS3_leach_n_2_rw, \
    deepS3_leach_i_2_rw, soilW4_runoff_n_2_rw, soilW4_runoff_i_2_rw, soilS4_erosion_n_2_rw, soilS4_erosion_i_2_rw, \
    deepS4_leach_n_2_rw, deepS4_leach_i_2_rw = \
        air_rain_diss_n_to_rw, aer_dep_wet_n_to_rSS, aer_dep_wet_i_to_rSS, \
        aer_dep_dry_n_to_rSS, aer_dep_dry_i_to_rSS, air_diff_n_to_rw, rSedW_diff_n_to_rw, \
        rSedW_diff_i_to_rw, rSedS_resusp_n, rSedS_resusp_i, \
        soilW1_runoff_n_river, soilW1_runoff_i_river, soilS1_erosion_n_river, soilS1_erosion_i_river, deepS1_leach_n_river, deepS1_leach_i_river, \
        soilW2_runoff_n_river, soilW2_runoff_i_river, soilS2_erosion_n_river, soilS2_erosion_i_river, deepS2_leach_n_river, deepS2_leach_i_river, \
        soilW3_runoff_n_river, soilW3_runoff_i_river, soilS3_erosion_n_river, soilS3_erosion_i_river, deepS3_leach_n_river, deepS3_leach_i_river, \
        soilW4_runoff_n_river, soilW4_runoff_i_river, soilS4_erosion_n_river, soilS4_erosion_i_river, deepS4_leach_n_river, deepS4_leach_i_river

    if presence['rw'] == 0:
        rw_deg_n, rw_deg_i, rSS_deg_n, rSS_deg_i, rwOut_adv_n, rwOut_adv_i, rSSOut_adv_n, rSSOut_adv_i, \
        rSS_dep_n, rSS_dep_i, rw_diff_n_to_air, rw_diff_n_to_rSedW, rw_diff_i_to_rSedW, air_rain_diss_n_2_rw, \
        aer_dep_wet_n_2_rSS, aer_dep_wet_i_2_rSS, \
        aer_dep_dry_n_2_rSS, aer_dep_dry_i_2_rSS, air_diff_n_2_rw, rSedW_diff_n_2_rw, rSedW_diff_i_2_rw, \
        rSedS_resusp_n_2_rw, rSedS_resusp_i_2_rw, soilW1_runoff_n_2_rw, soilW1_runoff_i_2_rw, soilS1_erosion_n_2_rw, \
        soilS1_erosion_i_2_rw, deepS1_leach_n_2_rw, deepS1_leach_i_2_rw, soilW2_runoff_n_2_rw, soilW2_runoff_i_2_rw, \
        soilS2_erosion_n_2_rw, soilS2_erosion_i_2_rw, deepS2_leach_n_2_rw, deepS2_leach_i_2_rw, soilW3_runoff_n_2_rw, \
        soilW3_runoff_i_2_rw, soilS3_erosion_n_2_rw, soilS3_erosion_i_2_rw, deepS3_leach_n_2_rw, deepS3_leach_i_2_rw, \
        soilW4_runoff_n_2_rw, soilW4_runoff_i_2_rw, soilS4_erosion_n_2_rw, soilS4_erosion_i_2_rw, deepS4_leach_n_2_rw, \
        deepS4_leach_i_2_rw = [0] * 47

    rw_loss = -(rw_deg_n + rw_deg_i + rSS_deg_n + rSS_deg_i + rwOut_adv_n + rwOut_adv_i + rSSOut_adv_n + rSSOut_adv_i +
                rSS_dep_n + rSS_dep_i + rw_diff_n_to_air + rw_diff_n_to_rSedW + rw_diff_i_to_rSedW)

    rw_transfer = air_rain_diss_n_2_rw + aer_dep_wet_n_2_rSS + \
                  aer_dep_wet_i_2_rSS + aer_dep_dry_n_2_rSS + aer_dep_dry_i_2_rSS + \
                  air_diff_n_2_rw + rSedW_diff_n_2_rw + rSedW_diff_i_2_rw + rSedS_resusp_n_2_rw + rSedS_resusp_i_2_rw +\
                  soilW1_runoff_n_2_rw + soilW1_runoff_i_2_rw + soilS1_erosion_n_2_rw + soilS1_erosion_i_2_rw + \
                  deepS1_leach_n_2_rw + deepS1_leach_i_2_rw + soilW2_runoff_n_2_rw + soilW2_runoff_i_2_rw + \
                  soilS2_erosion_n_2_rw + soilS2_erosion_i_2_rw + deepS2_leach_n_2_rw + deepS2_leach_i_2_rw + \
                  soilW3_runoff_n_2_rw + soilW3_runoff_i_2_rw + soilS3_erosion_n_2_rw + soilS3_erosion_i_2_rw + \
                  deepS3_leach_n_2_rw + deepS3_leach_i_2_rw + soilW4_runoff_n_2_rw + soilW4_runoff_i_2_rw + \
                  soilS4_erosion_n_2_rw + soilS4_erosion_i_2_rw + deepS4_leach_n_2_rw + deepS4_leach_i_2_rw


    # riverwater sediment - rwSed Q[2]
    rwSed_enter = release['rwSed'][i] + rSed_adv_inflow_n + rSed_adv_inflow_i

    rw_diff_n_2_rSedW, rw_diff_i_2_rSedW, rSS_dep_n_2_rwSed, rSS_dep_i_2_rwSed = \
        rw_diff_n_to_rSedW, rw_diff_i_to_rSedW, rSS_dep_n, rSS_dep_i

    if presence['rw'] == 0:
        rSedW_deg_n, rSedW_deg_i, rSedS_deg_n, rSedS_deg_i, rSedS_burial_n, rSedS_burial_i, rSedS_resusp_n, \
        rSedS_resusp_i, rSedW_diff_n_to_rw, rSedW_diff_i_to_rw, rSed_adv_outflow_n, rSed_adv_outflow_i, \
        rw_diff_n_2_rSedW, rw_diff_i_2_rSedW, rSS_dep_n_2_rwSed, rSS_dep_i_2_rwSed = [0] * 16

    rwSed_loss = -(rSedW_deg_n + rSedW_deg_i + rSedS_deg_n + rSedS_deg_i + rSedS_burial_n + rSedS_burial_i +
                   rSedS_resusp_n + rSedS_resusp_i + rSedW_diff_n_to_rw + rSedW_diff_i_to_rw + rSed_adv_outflow_n
                   + rSed_adv_outflow_i)

    rwSed_transfer = rw_diff_n_2_rSedW + rw_diff_i_2_rSedW + rSS_dep_n_2_rwSed + rSS_dep_i_2_rwSed
    ...
    deepS4_leach_n_2_fw, deepS4_leach_i_2_fw = \
        ...
        soilW1_runoff_n_fresh, soilW1_runoff_i_fresh, soilS1_erosion_n_fresh, soilS1_erosion_i_fresh, deepS1_leach_n_fresh, deepS1_leach_i_fresh, \
        soilW2_runoff_n_fresh, soilW2_runoff_i_fresh, soilS2_erosion_n_fresh, soilS2_erosion_i_fresh, deepS2_leach_n_fresh, deepS2_leach_i_fresh, \
        soilW3_runoff_n_fresh, soilW3_runoff_i_fresh, soilS3_erosion_n_fresh, soilS3_erosion_i_fresh, deepS3_leach_n_fresh, deepS3_leach_i_fresh, \
        soilW4_runoff_n_fresh, soilW4_runoff_i_fresh, soilS4_erosion_n_fresh, soilS4_erosion_i_fresh, deepS4_leach_n_fresh, deepS4_leach_i_fresh
    ...
    if (env['rwV'] * np.mean(Z_i['rw'])) != 0:
        rw = (rw_enter + rw_loss + rw_transfer) / (env['rwV'] * np.mean(Z_i['rw']))
    else:
        rw = 0
