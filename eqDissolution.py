...
#   Date Edited: Jan 17, 2022
#   Edited By: Kendra Garner, PhD
#
#################################################################


def eqDissolution(ENM,RWpH,FWpH,SWpH,GWpH1,GWpH2,GWpH3,GWpH4,presence):
	...
	#%% Riverwater
	#TODO: confirm with Arturo use freshwater to proxy river water
	if presence['rw']==0: #% if there is no riverwater compartment
		percfitaRW=0
		percfitbRW=0
	else:
		# % Finding the closest RW pH
		vec=[7.5,8,8.33,8.5,9]
		RWlower = sub(vec, lambda x: x<=RWpH, 'last')
		RWhigher = sub(vec, lambda x: x>=RWpH, 'first')
		if RWlower == []:
			RWpH=RWhigher
		elif RWhigher == []:
			RWpH=RWlower
		elif abs(RWlower-RWpH)<abs(RWhigher-RWpH):
			RWpH=RWlower
		else:
			RWpH=RWhigher
	...
	if ENM == 'Ag':
		if RWpH==7.5:
			percfitaRW=contents['Ag75FWpercfita'][0][0]
			percfitbRW=contents['Ag75FWpercfitb'][0][0]
		elif FWpH==8:
			percfitaRW=contents['Ag8FWpercfita'][0][0]
			percfitbRW=contents['Ag8FWpercfitb'][0][0]
		elif FWpH==8.33:
			percfitaRW=contents['Ag833FWpercfita'][0][0]
			percfitbRW=contents['Ag833FWpercfitb'][0][0]
		elif FWpH==8.5:
			percfitaRW=contents['Ag85FWpercfita'][0][0]
			percfitbRW=contents['Ag85FWpercfitb'][0][0]
		elif RWpH==9:
			percfitaRW=contents['Ag9FWpercfita'][0][0]
			percfitbRW=contents['Ag9FWpercfitb'][0][0]
	elif ENM == 'CuO':
		if RWpH==7.5:
			percfitaRW=contents['CuO75FWpercfita'][0][0]
			percfitbRW=contents['CuO75FWpercfitb'][0][0]
		elif RWpH==8:
			percfitaRW=contents['CuO8FWpercfita'][0][0]
			percfitbRW=contents['CuO8FWpercfitb'][0][0]
		elif RWpH==8.33:
			percfitaRW=contents['CuO833FWpercfita'][0][0]
			percfitbRW=contents['CuO833FWpercfitb'][0][0]
		elif RWpH==8.5:
			percfitaRW=contents['CuO85FWpercfita'][0][0]
			percfitbRW=contents['CuO85FWpercfitb'][0][0]
		elif RWpH==9:
			percfitaRW=contents['CuO9FWpercfita'][0][0]
			percfitbRW=contents['CuO9FWpercfitb'][0][0]
	elif ENM == 'nZVI':
		if RWpH==7.5:
			percfitaRW=contents['nZVI75FWpercfita'][0][0]
			percfitbRW=contents['nZVI75FWpercfitb'][0][0]
		elif RWpH==8:
			percfitaRW=contents['nZVI8FWpercfita'][0][0]
			percfitbRW=contents['nZVI8FWpercfitb'][0][0]
		elif RWpH==8.33:
			percfitaRW=contents['nZVI833FWpercfita'][0][0]
			percfitbRW=contents['nZVI833FWpercfitb'][0][0]
		elif RWpH==8.5:
			percfitaRW=contents['nZVI85FWpercfita'][0][0]
			percfitbRW=contents['nZVI85FWpercfitb'][0][0]
		elif RWpH==9:
			percfitaRW=contents['nZVI9FWpercfita'][0][0]
			percfitbRW=contents['nZVI9FWpercfitb'][0][0]
	elif ENM == 'ZnO':
		if RWpH==7.5:
			percfitaRW=contents['ZnO75FWpercfita'][0][0]
			percfitbRW=contents['ZnO75FWpercfitb'][0][0]
		elif RWpH==8:
			percfitaRW=contents['ZnO8FWpercfita'][0][0]
			percfitbRW=contents['ZnO8FWpercfitb'][0][0]
		elif RWpH==8.33:
			percfitaRW=contents['ZnO833FWpercfita'][0][0]
			percfitbRW=contents['ZnO833FWpercfitb'][0][0]
		elif RWpH==8.5:
			percfitaRW=contents['ZnO85FWpercfita'][0][0]
			percfitbRW=contents['ZnO85FWpercfitb'][0][0]
		elif RWpH==9:
			percfitaRW=contents['ZnO9FWpercfita'][0][0]
			percfitbRW=contents['ZnO9FWpercfitb'][0][0]
	elif ENM== 'TiO2':
		percfitaRW=contents['TiO2FWpercfita'][0][0]
		percfitbRW=contents['TiO2FWpercfitb'][0][0]
	elif ENM== 'CeO2':
		percfitaRW=contents['CeO2FWpercfita'][0][0]
		percfitbRW=contents['CeO2FWpercfitb'][0][0]
	elif ENM== 'SiO2':
		percfitaRW=contents['SiO2FWpercfita'][0][0]
		percfitbRW=contents['SiO2FWpercfitb'][0][0]
	...
	DIS = {}
	DIS['percfitaRW']=percfitaRW
	DIS['percfitbRW']=percfitbRW
